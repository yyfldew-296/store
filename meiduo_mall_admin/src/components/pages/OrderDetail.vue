<template>
  <div class="user_wrap">
    ...
    <div class="center_wrap">
      ...
      <el-row class="order_line">
        <el-col :span="8">
          付款方式：{{ oOrder.pay_method | paystyle }}
        </el-col>
        <el-col :span="8">
          状态：{{ oOrder.status | process }}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          <el-button size="mini" round @click="pop_show=true">修改状态</el-button>
          </el-col>
      </el-row>
...
export default {
  ...
  data () {
    return {
      express_check_pop_show: false,
      edit_id:'',
      oOrder:{},
      pop_show:false,
      express_pop_show: false,
      statusForm:{
        status:''
      },
      status_list:[
  ...
  methods:{
    ...
    submitForm(){
      let token = localStorage.token
      this.axios.patch(cons.apis + '/orders/'+this.edit_id+'/status/', {
